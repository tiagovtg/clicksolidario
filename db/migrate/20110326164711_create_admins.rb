class CreateAdmins < ActiveRecord::Migration
  ...
  def self.up
    ...
    execute " INSERT INTO users (id, email, crypted_password, password_salt, persistence_token, single_access_token, perishable_token, failed_login_count, last_request_at, current_login_ip, status, created_at, updated_at) VALUES
